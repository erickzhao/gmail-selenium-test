...
const { Credentials } = require('./users');

// store all By locators in a single file for reuse and modularity

// some take parameters because different scenarios call for different
// subjects, bodies, recipients, cc, and file extensions.
const locators = {
  signin: {
  ...
  verify: {
    sent: {
      ...
      senderInfo: By.xpath(
        `//span[contains(., "from:")]/parent::td/following-sibling::td/descendant::span[@email="${
          Credentials.email
        }"]`,
      ),
    ...
    unsent: {
      ...
      body: body => By.xpath(`//div[@aria-label="Message Body" and .="${body}"]`),
    },
  },
  after: {
